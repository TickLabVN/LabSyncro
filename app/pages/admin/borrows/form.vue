...
const handleVirtualKeyboardDetection = async (
  ...
  if (type === 'userId') {
    ...
    try {
      const { status } = await deviceService.checkDevice(
        deviceId,
        lab.value.id
      );
        ...
        <div class="flex flex-col gap-8 min-w-[350px]">
          <div class="bg-white p-4">
            <div class="flex gap-2 justify-between items-center mb-4">
              ...
              <OneTimeQrModal :is-open="showQrModal" :user-id="formState.userId" @close="showQrModal = false" />
            </div>
            <div role="form">
              <div class="mb-4">
                <div class="mb-2">
            ...
            <div role="form">
              ...
              <div class="space-y-4">
                <div class="space-y-2">
                  ...
                  <Input :model-value="formState.returnDate" type="date" class="text-lg p-4 rounded-xl border-2"
                    @update:model-value="
